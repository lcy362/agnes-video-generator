...
# This copy lives inside agnes-video-generator itself, so the backend is the
# parent directory (not a sibling folder, as the standalone copy assumes).
AGNES_DIR="${AGNES_DIR:-$SCRIPT_DIR/..}"
